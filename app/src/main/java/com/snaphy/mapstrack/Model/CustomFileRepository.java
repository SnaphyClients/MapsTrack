...
public class CustomFileRepository extends FileRepository {
     ...
     */
    public void uploadAmazon(java.io.File localFile, final ObjectCallback<com.snaphy.mapstrack.Model.ImageModel> callback) {
    ...
    private class CustomUploadResponseParser extends Adapter.JsonObjectCallback {
        ...
        private final ObjectCallback<com.snaphy.mapstrack.Model.ImageModel> callback;

        private CustomUploadResponseParser(FileRepository repository, ObjectCallback<com.snaphy.mapstrack.Model.ImageModel> callback) {
